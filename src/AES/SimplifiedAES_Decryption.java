...
public class SimplifiedAES_Decryption{
	   ...
	   public static void main(String[] args){
	      ...
	      for(int i = 0; i < a.length; i++){
	         for(int j = 0; j < a.length; j++){
	            System.out.print(aesENC.checkSymbol2(a[i][j])+" ");
	         }
	         System.out.println();
	      }
	      ...
	      for(int i = 0; i < mc.length; i++){
	         for(int j = 0; j < mc.length; j++){
	            System.out.print(aesENC.checkSymbol2(mc[i][j])+" ");
	         }
	         System.out.println();
	      }
	      ...
	      for(int i = 0; i < shr.length; i++){
	         for(int j = 0; j < shr.length; j++){
	            System.out.print(aesENC.checkSymbol2(shr[i][j])+" ");
	         }
	         System.out.println();
	      }
	      ...
	      for(int i = 0; i < sub.length; i++){
	         for(int j = 0; j < sub.length; j++){
	            System.out.print(aesENC.checkSymbol2(sub[i][j])+" ");
	         }
	         System.out.println();
	      }     
	   }
